            ...
            <div style={{ background: 'var(--bg-dark)', minHeight: '100vh', position: 'relative', overflowX: 'hidden' }}>
                ...
                <section style={{
                    ...
                    <div className="container">
                        ...
                        {/* 3D Isometric Animation Container */}
                        <div style={{
                            position: 'relative',
                            height: `${600 * scale}px`, // Dynamic height based on scale
                            perspective: '2000px',
                            display: 'flex',
                            justifyContent: 'center',
                            alignItems: 'center',
                            marginTop: scale < 0.6 ? '0' : '-4rem', // Remove negative margin on mobile to avoid overlap
                            width: '100%',
                            overflow: 'hidden'
                        }}>
